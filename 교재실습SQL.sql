...
SELECT DNAME, 'TI''S DEPTNO : ', DEPTNO "DNAME AND DEPTNO" FROM DEPT;
...
SELECT STUDNO AS "'S ID:", WEIGHT "ID AND WEIGHT" FROM STUDENT;
SELECT NAME, STUDNO, WEIGHT, STUDNO || ' / ' || WEIGHT 
